INTERIORS = {
    ...
    -- FIB GARAGE 155.12008666992,-688.14208984375,33.12992477417
    [6] = {id = 6, x = 142.06883239746, y = -768.97241210938, z = 45.752010345459, h = 72.884956359863, name = "FIB Building", destination = {7}},
    [7] = {id = 7, x = 155.12008666992, y = -688.14208984375, z = 33.12992477417, name = "Garage", destination = {6}},
...
-- Lawyer
	...
	-- TP to Paleto PD	 115.82763671875,-740.70477294922,258.15209960938   -453.97631835938,6041.3051757812,31.34052848816
    [24] = {id = 24, x =  115.82763671875, y = -740.70477294922, z = 258.15209960938,  name = "Go to FBI Building", destination = {25}},
    [25] = {id = 25, x =  -453.97631835938, y = 6041.3051757812, z = 31.34052848816,  name = "Go to Paleto PD", destination = {24}},
	-- TP inside the mine -595.72729492188,2087.7062988282,131.36962890625    -596.40490722656,2089.3742675782,131.4126739502
    [26] = {id = 26, x =  -596.40490722656, y = 2089.3742675782, z = 131.4126739502,  name = "Enter the Mine", destination = {27}},
    [27] = {id = 27, x =  -595.72729492188, y = 2087.7062988282, z = 131.36962890625,  name = "Exit the Mine", destination = {26}},	
}
